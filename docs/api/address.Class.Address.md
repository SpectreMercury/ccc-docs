...
[@ckb-ccc/core](README.md) / [address](address.md) / Address
...
> **new Address**(`script`, `prefix`): [`Address`](address.Class.Address.md)

Creates an instance of Address.

#### Parameters

• **script**: [`Script`](ckb.script.Class.Script.md)
...
> `static` **from**(`address`): [`Address`](address.Class.Address.md)

Creates an Address instance from an AddressLike object.

#### Parameters

• **address**: [`AddressLike`](address.Type.AddressLike.md)
...
> `static` **fromKnownScript**(`script`, `args`, `client`): `Promise`\<[`Address`](address.Class.Address.md)\>
...
> `static` **fromScript**(`script`, `client`): `Promise`\<[`Address`](address.Class.Address.md)\>
...
> `static` **fromString**(`address`, `clients`): `Promise`\<[`Address`](address.Class.Address.md)\>
...
• **clients**: [`Client`](client.client.Interface.Client.md) \| `Record`\<`string`, [`Client`](client.client.Interface.Client.md)\>
